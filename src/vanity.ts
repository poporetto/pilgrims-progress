...
export class VanityScene {
  ...
  afterMove(): void {
    ...
    if (this.phase === 'walk' && p.x > TALKATIVE_X - 3) {
      ...
      this.cb.playScript([
        ...
        { speaker: 'Talkative', text: 'Changed my—? Ha! Well, teachings about change are a WONDERFUL subject! Augustine says—or rather, many teachers say that—' },
  ...
  private runTrial(): void {
    this.cb.playScript([
      ...
      { speaker: 'Judge Hate-Good', text: 'The KING, he says! Beelzebub has ruled this fair for a thousand years, little sheep! Reject your King, buy something nice, and the court may still show you mercy.' },
